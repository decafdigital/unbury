        ...
        <Card padded={false} className="overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-black bg-paperSoft text-left text-xs font-extrabold uppercase tracking-wider text-black">
                  <th className="px-5 py-3">Name</th>
                  <th className="px-5 py-3 text-right">Balance</th>
                  <th className="px-5 py-3 text-right">APR</th>
                  <th className="px-5 py-3 text-right">Min. payment</th>
                  <th className="px-5 py-3 text-right">Interest / mo</th>
              ...
              <tfoot>
                <tr className="border-t-2 border-black bg-paperSoft text-sm">
                  <td className="px-5 py-3 font-extrabold text-black">Total</td>
                  <td className="tnum px-5 py-3 text-right font-black text-black">
                  ...
                  <td className="tnum px-5 py-3 text-right font-black text-negative">
      ...
      >
        <td className="px-5 py-3 font-medium text-ink">
          ...
          {stalled && (
            <span
              title={tooltipText}
              className="ml-2 inline-flex cursor-help items-center gap-1 rounded-full border-2 border-black bg-negative px-2 py-0.5 text-xs font-extrabold uppercase tracking-wider text-white"
            >
              <svg
