        ...
        <ol className="flex flex-col gap-3">
          {order.map((id, idx) => {
            ...
            return (
              <li
                key={id}
                className="flex flex-wrap items-center gap-4 rounded-lg border-2 border-black bg-paperSoft p-4"
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-black bg-brand-500 text-sm font-black text-black">
                  {idx + 1}
                </div>
        ...
        <ol className="flex flex-col gap-3">
          {debts.map((d, idx) => (
            <li
              ...
              className="flex flex-wrap items-center gap-4 rounded-lg border-2 border-black bg-paperSoft p-4"
            >
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 border-black bg-brand-500 text-sm font-black text-black">
                {idx + 1}
              </div>
              <div className="min-w-0 flex-1">
                <p className="truncate font-medium text-ink">{d.name}</p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {rows.slice(0, 24).map((row) => (
                  <tr key={row.month} className="border-t border-black/10">
